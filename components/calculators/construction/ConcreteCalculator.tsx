...
export function ConcreteCalculator() {
  ...
  const { results, error, formulaDesc } = useMemo(() => {
    ...
    // Enforce upper bounds to prevent browser abuse
    ...
    switch (shape) {
      ...
      case 'column':
        ...
        break;
      case 'stairs':
        formulaStr = `Volume = Width × Run Depth × Riser Height × Number of Steps`;
        break;
    }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          <div className="p-5 bg-secondary-50 dark:bg-secondary-900/30 rounded-xl border border-border space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              {/* Depth/Height/Thickness is mostly universal */}
              <div className="space-y-2">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-card p-6 rounded-2xl border border-border">
            ...
            <div className="space-y-2">
              <SecondaryResultDisplay label="Material (Ready-Mix)" value={!costValues ? '--' : `$${formatUnit(costValues.materialYard)}`} />
              ...
              <p className="text-xs text-secondary-500 mt-4 leading-relaxed">
                Using bags instead? 80lb bags would cost roughly ${costValues ? formatUnit(costValues.materialBags) : '--'} (excluding delivery/labor).
              </p>
            </div>
          </div>
          ...
          <div className="bg-secondary-100 dark:bg-secondary-800/50 p-4 rounded-xl text-sm text-secondary-600 dark:text-secondary-400">
            ...
            <br/><br/>
            Raw volume is normalized to cubic feet, then multiplied by 1.{wasteFactor.toString().padStart(2, '0')} (waste), and finally divided by 27 to find Cubic Yards.
          </div>
